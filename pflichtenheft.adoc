...
image::http://www.plantuml.com/plantuml/proxy?cache=no&src=https://github.com/1920-3ahif-syp/01-project-prposal-EminaSljivic/blob/master/klassendiagramm.iuml[Example]

image::http://www.plantuml.com/plantuml/proxy?cache=no&src=https://github.com/1920-3ahif-syp/01-project-prposal-EminaSljivic/blob/master/usecasediagramm.iuml[Example]
